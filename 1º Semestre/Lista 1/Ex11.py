...
materia1=float(input("Escreva a média de nota da matéria 1: "));
materia2=float(input("Escreva a média de nota da matéria 2: "));
materia3=float(input("Escreva a média de nota da matéria 3: "));
