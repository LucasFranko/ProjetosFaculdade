// Fazer um programa para validar o CPF inserido pelo usuário é válido. O CPF é um número composto por 11 dígitos, em que os 2 últimos são dígitos verificadores. 
...
// O resultado da soma, 10A + 9B + 8C + 7D + 6E + 5F + 4G + 3H + 2I, é dividido por 11. Analisamos então o RESTO dessa divisão: Se for 0 ou 1, o dígito J é [0] (zero). 
...
// O resultado da soma, 11A + 10B + 9C + 8D + 7E + 6F + 5G + 4H + 3I + 2J, é dividido por 11. Verificamos então o RESTO dessa divisão: Se for 0 ou 1, o dígito K é [0] (zero). 
